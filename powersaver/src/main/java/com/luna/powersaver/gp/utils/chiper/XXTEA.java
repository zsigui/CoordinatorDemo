...
public final class XXTEA {
    ...
    public static final byte[] encrypt(String data, byte[] key) {
        try {
            return encrypt(data.getBytes(CommonUtil.DEFAULT_SYS_CHARSET), key);
        }
    ...
    public static final byte[] encrypt(byte[] data, String key) {
        try {
            return encrypt(data, key.getBytes(CommonUtil.DEFAULT_SYS_CHARSET));
        }
        catch (UnsupportedEncodingException e) {
            return null;
        }
    ...
    public static final byte[] encrypt(String data, String key) {
        try {
            return encrypt(data.getBytes(CommonUtil.DEFAULT_SYS_CHARSET), key.getBytes(CommonUtil.DEFAULT_SYS_CHARSET));
        }
        catch (UnsupportedEncodingException e) {
            return null;
        }
    ...
    public static final byte[] decrypt(byte[] data, String key) {
        try {
            return decrypt(data, key.getBytes(CommonUtil.DEFAULT_SYS_CHARSET));
        }
        catch (UnsupportedEncodingException e) {
            e.printStackTrace();
            return null;
    ...
    public static final String decryptToString(byte[] data, byte[] key) {
        try {
            ...
            if (bytes == null) return null;
            return new String(bytes, CommonUtil.DEFAULT_SYS_CHARSET);
        }
